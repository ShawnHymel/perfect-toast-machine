...
// {temp, humd, voc2, no2, eth, co}
static const float means[] = {75.502, 8.4883, 2.5958, 2.2113, 2.6475, 2.1576};
static const float std_devs[] = {23.2281, 9.0292, 0.3656, 0.5479, 0.3673, 0.4927};
...
void loop() {
  ...
  if ((millis() - sample_timestamp) >= SAMPLE_DELAY) {
    ...
    frame_buf[2] = gm_voc_v;
    frame_buf[3] = gm_no2_v;
    frame_buf[4] = gm_eth_v;
    frame_buf[5] = gm_co_v;
